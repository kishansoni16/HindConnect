...
// Ensure database connection is initialized before handling any routes on Vercel serverless
app.use(async (req, res, next) => {
  try {
    await connectDB();
  } catch (err) {
    console.error('Database connection promise error in middleware:', err);
  }
  next();
});
